  ...
  return /*html*/ `
         <div class="container-fluid d-flex align-items-center justify-content-between">
           ...
           <div id="middle d-flex flex-column" style="width:50%;">
              ...
              <img class="mx-2" src="./assets/assets-playerbar/previous_track.svg" alt=""/>
              <img class="mx-2" style="height:30px; width: 30px;" src="./assets/assets-playerbar/playbutton.svg" alt=""/>
              <img class="mx-2" src="./assets/assets-playerbar/next_track.svg" alt=""/>
           ...
           <img class="mx-2" src="./assets/assets-playerbar/mute.svg" alt=""/>
